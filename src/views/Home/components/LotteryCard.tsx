...
const FarmedStakingCard = () => {
  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        <CardTitle>{TranslateString(550, 'รางวัลลอตเตอรี่ของคุณ')}</CardTitle>
        <CardImage src="/images/ticket.svg" alt="cake logo" />
        <Block>
          <Value>
            <CakeWinnings />
          </Value>
          <Label>{TranslateString(552, 'เค้ก to คอลเลคชั่น')}</Label>
        </Block>
        <Block>
          <Value>
            <LotteryJackpot />
          </Value>
          <Label>{TranslateString(554, 'แจ็คพอต รอบนี้')}</Label>
        </Block>
        <Actions>
          <Button
